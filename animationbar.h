...
public:
    ...
    AnimationBar(QWidget *parent, char* winName, cv::Mat *image, int window_width, int window_height, int total_time, float fps, std::list<TempoChange> *tempos, RenderP *renderproperties);

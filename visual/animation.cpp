...
void AnimPainter::paintNotes(MusicData mdt, cv::Mat image, std::vector <cv::Mat> img_buffer_sep_tracks, cv::Mat img_playing_notes, cv::Mat img_moving_notes, AnimWindow aw, LayerContainer layerCt, RenderP rProp) // this function is called for every frame. aw.StartMidiTime is the time in the left side of the window, aw.EndMidiTime, at the right. These depend on playback position and zoom.
{
    ...
    BlockLayers blockL = layerCt.Bl;
    ChordLayers chordL = layerCt.Cl;
                ...
                for (unsigned int tnum = 0; tnum < mdt.NTracks; tnum++)
                {
                    ...
                    if (blockL.interconnect[tnum] == 1) // All tracks - rectangle
                    {
                        ...
                        if (abs(spts.pt3.x - spts.pt5[tnum].x) < rProp.max_connect_dist && spts.pt5[tnum] != cv::Point(0,0))
                            if ( ! rProp.sep_render[1])
                                cv::line( image, spts.pt3, spts.pt5[tnum], {(double)layerCt.getCv(tnum,2)/4,  (double)layerCt.getCv(tnum,1)/4,  (double)layerCt.getCv(tnum,0)/4}, 1, lineType );
                            else
                                cv::line( img_buffer_sep_tracks[tnum], spts.pt3, spts.pt5[tnum], {(double)layerCt.getCv(tnum,2)/4,  (double)layerCt.getCv(tnum,1)/4,  (double)layerCt.getCv(tnum,0)/4}, 1, lineType );
                    ...
                    if (blockL.shape[tnum] == 0) // All tracks - rectangle
                    {
                        if (spts.pt1.x > aw.Width/2) // The note block is before (to the right of) the center line
                            if ( ! rProp.sep_render[1])
                                cv::rectangle( image, spts.pt1, spts.pt2, {layerCt.getColour(tnum, (*it).pitch).b*(*it).vel/dcr, layerCt.getColour(tnum, (*it).pitch).g*(*it).vel/dcr, layerCt.getColour(tnum, (*it).pitch).r*(*it).vel/dcr}, -1, lineType );
                            else
                                cv::rectangle( img_buffer_sep_tracks[tnum], spts.pt1, spts.pt2, {layerCt.getColour(tnum, (*it).pitch).b*(*it).vel/dcr, layerCt.getColour(tnum, (*it).pitch).g*(*it).vel/dcr, layerCt.getColour(tnum, (*it).pitch).r*(*it).vel/dcr}, -1, lineType );
                        else if (spts.pt1.x <= aw.Width/2 && spts.pt2.x > aw.Width/2) // The note block is inside the center line
                        {
                            if ( ! rProp.sep_render[0])
                                cv::rectangle( image, spts.pt1, spts.pt2, {layerCt.getColour(tnum, (*it).pitch).b*(*it).vel/dcp, layerCt.getColour(tnum, (*it).pitch).g*(*it).vel/dcp, layerCt.getColour(tnum, (*it).pitch).r*(*it).vel/dcp}, -1, lineType );
                            else
                                cv::rectangle( img_playing_notes, spts.pt1, spts.pt2, {layerCt.getColour(tnum, (*it).pitch).b*(*it).vel/dcp, layerCt.getColour(tnum, (*it).pitch).g*(*it).vel/dcp, layerCt.getColour(tnum, (*it).pitch).r*(*it).vel/dcp}, -1, lineType );
                        }
                        else // The note block is after (to the left of) the center line
                            if ( ! rProp.sep_render[1])
                                cv::rectangle( image, spts.pt1, spts.pt2, {layerCt.getColour(tnum, (*it).pitch).b*(*it).vel/dcl, layerCt.getColour(tnum, (*it).pitch).g*(*it).vel/dcl, layerCt.getColour(tnum, (*it).pitch).r*(*it).vel/dcl}, 2, lineType );
                            else
                                cv::rectangle( img_buffer_sep_tracks[tnum], spts.pt1, spts.pt2, {layerCt.getColour(tnum, (*it).pitch).b*(*it).vel/dcl, layerCt.getColour(tnum, (*it).pitch).g*(*it).vel/dcl, layerCt.getColour(tnum, (*it).pitch).r*(*it).vel/dcl}, 2, lineType );
                    }
                    ...
                    else if (blockL.shape[tnum] == 1) // All tracks - rectangle
                    {
                        ...
                        if (spts.pt1.x > aw.Width/2) // The note block is before (to the right of) the center line
                            if ( ! rProp.sep_render[1])
                                ...
                                cv::fillConvexPoly( image, ptos, 4, {layerCt.getColour(tnum, (*it).pitch).b*(*it).vel/dcr, layerCt.getColour(tnum, (*it).pitch).g*(*it).vel/dcr, layerCt.getColour(tnum, (*it).pitch).r*(*it).vel/dcr}, lineType );
                            else
                                cv::fillConvexPoly( img_buffer_sep_tracks[tnum], ptos, 4, {layerCt.getColour(tnum, (*it).pitch).b*(*it).vel/dcr, layerCt.getColour(tnum, (*it).pitch).g*(*it).vel/dcr, layerCt.getColour(tnum, (*it).pitch).r*(*it).vel/dcr}, lineType );
                        else if (spts.pt1.x <= aw.Width/2 && spts.pt2.x > aw.Width/2) // The note block is inside the center line
                        {
                            if ( ! rProp.sep_render[0])
                            ...
                            if ( ! rProp.sep_render[1])
                                cv::fillConvexPoly( image, ptos, 4, {layerCt.getColour(tnum, (*it).pitch).b*(*it).vel/dcl, layerCt.getColour(tnum, (*it).pitch).g*(*it).vel/dcl, layerCt.getColour(tnum, (*it).pitch).r*(*it).vel/dcl}, lineType );
                            else
                                cv::fillConvexPoly( img_buffer_sep_tracks[tnum], ptos, 4, {layerCt.getColour(tnum, (*it).pitch).b*(*it).vel/dcl, layerCt.getColour(tnum, (*it).pitch).g*(*it).vel/dcl, layerCt.getColour(tnum, (*it).pitch).r*(*it).vel/dcl}, lineType );
                    }
                    ...
                    else if (blockL.shape[tnum] == 2) // All tracks - rectangle
                    {
                        ...
                        if (spts.pt1.x > aw.Width/2) // The note block is before (to the right of) the center line
                            if ( ! rProp.sep_render[1])
                                //cv::fillPoly( image, pts, );
                                cv::ellipse( image, spts.pt3, cv::Size(spts.x3-spts.x1, spts.y3-spts.y2), 0, 0, 360, {layerCt.getColour(tnum, (*it).pitch).b*(*it).vel/dcr, layerCt.getColour(tnum, (*it).pitch).g*(*it).vel/dcr, layerCt.getColour(tnum, (*it).pitch).r*(*it).vel/dcr}, -1, lineType);
                            else
                                cv::ellipse( img_buffer_sep_tracks[tnum], spts.pt3, cv::Size(spts.x3-spts.x1, spts.y3-spts.y2), 0, 0, 360, {layerCt.getColour(tnum, (*it).pitch).b*(*it).vel/dcr, layerCt.getColour(tnum, (*it).pitch).g*(*it).vel/dcr, layerCt.getColour(tnum, (*it).pitch).r*(*it).vel/dcr}, -1, lineType);
                        else if (spts.pt1.x <= aw.Width/2 && spts.pt2.x > aw.Width/2) // The note block is inside the center line
                        {
                            if ( ! rProp.sep_render[0])
                                cv::ellipse( image, spts.pt3, cv::Size(spts.x3-spts.x1, spts.y3-spts.y2), 0, 0, 360, {layerCt.getColour(tnum, (*it).pitch).b*(*it).vel/dcp, layerCt.getColour(tnum, (*it).pitch).g*(*it).vel/dcp, layerCt.getColour(tnum, (*it).pitch).r*(*it).vel/dcp}, -1, lineType);
                            else
                                cv::ellipse( img_playing_notes, spts.pt3, cv::Size(spts.x3-spts.x1, spts.y3-spts.y2), 0, 0, 360, {layerCt.getColour(tnum, (*it).pitch).b*(*it).vel/dcp, layerCt.getColour(tnum, (*it).pitch).g*(*it).vel/dcp, layerCt.getColour(tnum, (*it).pitch).r*(*it).vel/dcp}, -1, lineType);
                        }
                        else // The note block is after (to the left of) the center line
                            if ( ! rProp.sep_render[1])
                                cv::ellipse( image, spts.pt3, cv::Size(spts.x3-spts.x1, spts.y3-spts.y2), 0, 0, 360, {layerCt.getColour(tnum, (*it).pitch).b*(*it).vel/dcl, layerCt.getColour(tnum, (*it).pitch).g*(*it).vel/dcl, layerCt.getColour(tnum, (*it).pitch).r*(*it).vel/dcl}, 2, lineType);
                            else
                                cv::ellipse( img_buffer_sep_tracks[tnum], spts.pt3, cv::Size(spts.x3-spts.x1, spts.y3-spts.y2), 0, 0, 360, {layerCt.getColour(tnum, (*it).pitch).b*(*it).vel/dcl, layerCt.getColour(tnum, (*it).pitch).g*(*it).vel/dcl, layerCt.getColour(tnum, (*it).pitch).r*(*it).vel/dcl}, 2, lineType);
                    }
                    ...
                    else if (blockL.shape[tnum] == 3) // All tracks
                    {
                        ...
                        if (spts.pt1.x > aw.Width/2) // The note block is before (to the right of) the center line
                            if ( ! rProp.sep_render[1])
                                //cv::fillPoly( image, pts, );
                                cv::circle( image, spts.pt3, radius, {layerCt.getColour(tnum, (*it).pitch).b*(*it).vel/dcr, layerCt.getColour(tnum, (*it).pitch).g*(*it).vel/dcr, layerCt.getColour(tnum, (*it).pitch).r*(*it).vel/dcr}, -1, lineType );
                            else
                                cv::circle( img_buffer_sep_tracks[tnum], spts.pt3, radius, {layerCt.getColour(tnum, (*it).pitch).b*(*it).vel/dcr, layerCt.getColour(tnum, (*it).pitch).g*(*it).vel/dcr, layerCt.getColour(tnum, (*it).pitch).r*(*it).vel/dcr}, -1, lineType );
                        else if (spts.pt1.x <= aw.Width/2 && spts.pt2.x > aw.Width/2) // The note block is inside the center line
                        {
                            if ( ! rProp.sep_render[0])
                                cv::circle( image, spts.pt3, (spts.x2-aw.Width/2+3), {layerCt.getColour(tnum, (*it).pitch).b*(*it).vel/dcp, layerCt.getColour(tnum, (*it).pitch).g*(*it).vel/dcp, layerCt.getColour(tnum, (*it).pitch).r*(*it).vel/dcp}, -1, lineType );
                            else
                                cv::circle( img_playing_notes, spts.pt3, (spts.x2-aw.Width/2+1), {layerCt.getColour(tnum, (*it).pitch).b*(*it).vel/dcp, layerCt.getColour(tnum, (*it).pitch).g*(*it).vel/dcp, layerCt.getColour(tnum, (*it).pitch).r*(*it).vel/dcp}, -1, lineType );
                        }
                        else // The note block is after (to the left of) the center line
                            if ( ! rProp.sep_render[1])
                                cv::circle( image, spts.pt3, radius, {layerCt.getColour(tnum, (*it).pitch).b*(*it).vel/dcl, layerCt.getColour(tnum, (*it).pitch).g*(*it).vel/dcl, layerCt.getColour(tnum, (*it).pitch).r*(*it).vel/dcl}, 2, lineType );
                            else
                                cv::circle( img_buffer_sep_tracks[tnum], spts.pt3, radius, {layerCt.getColour(tnum, (*it).pitch).b*(*it).vel/dcl, layerCt.getColour(tnum, (*it).pitch).g*(*it).vel/dcl, layerCt.getColour(tnum, (*it).pitch).r*(*it).vel/dcl}, 2, lineType );
                    }
                            ...
                            // corresponding track (so, spts.pt1_prev[tnum], spts.pt2_prev[tnum] etc.), because we don't want the very last note as previous note, but the previous note of the same track!
                        {
                            ...
                            if (spts.pt1.x - spts.pt2_prev[tnum].x > 5) // next_note t_on and old note t_off are far
                                if ( ! rProp.sep_render[2])
                                    cv::circle( image, spts.pt3_prev[tnum], floor1(spts.pt2_prev[tnum].x-aw.Width/2+1), {layerCt.getColour(tnum, (*it).pitch).b*(*it).vel/dcf, layerCt.getColour(tnum, (*it).pitch).g*(*it).vel/dcf, layerCt.getColour(tnum, (*it).pitch).r*(*it).vel/dcf}, -1, lineType);
                                else
                                    cv::circle( img_moving_notes, spts.pt3_prev[tnum], floor1(spts.pt2_prev[tnum].x-aw.Width/2+1), {layerCt.getColour(tnum, (*it).pitch).b*(*it).vel/dcf, layerCt.getColour(tnum, (*it).pitch).g*(*it).vel/dcf, layerCt.getColour(tnum, (*it).pitch).r*(*it).vel/dcf}, -1, lineType);
                            // Case 2: the end of the current note (prev) is close to the begin of the new note (legato) -> notes connect themselves
                            else
                                if ( ! rProp.sep_render[2])
                                    cv::circle( image, cv::Point(x_mov, y_mov), floor1(spts.RadiusPrev[tnum] + deriv*((float)radius - (float)spts.RadiusPrev[tnum])), {layerCt.getColour(tnum, (*it).pitch).b*(*it).vel/dcm, layerCt.getColour(tnum, (*it).pitch).g*(*it).vel/dcm, layerCt.getColour(tnum, (*it).pitch).r*(*it).vel/dcm}, -1, lineType);
                                else
                                    cv::circle( img_moving_notes, cv::Point(x_mov, y_mov), floor1(spts.RadiusPrev[tnum] + deriv*((float)radius - (float)spts.RadiusPrev[tnum])), {layerCt.getColour(tnum, (*it).pitch).b*(*it).vel/dcm, layerCt.getColour(tnum, (*it).pitch).g*(*it).vel/dcm, layerCt.getColour(tnum, (*it).pitch).r*(*it).vel/dcm}, -1, lineType);
                    ...
                    else if (blockL.shape[tnum] == 5) // All tracks
                    {
                        ...
                        {
                            if ( ! rProp.sep_render[0])
                                cv::circle( image, spts.pt3, radius, {layerCt.getColour(tnum, (*it).pitch).b*(*it).vel/dcmp, layerCt.getColour(tnum, (*it).pitch).g*(*it).vel/dcmp, layerCt.getColour(tnum, (*it).pitch).r*(*it).vel/dcmp}, 4, lineType);
                            else
                                cv::circle( img_playing_notes, spts.pt3, radius, {layerCt.getColour(tnum, (*it).pitch).b*(*it).vel/dcmp, layerCt.getColour(tnum, (*it).pitch).g*(*it).vel/dcmp, layerCt.getColour(tnum, (*it).pitch).r*(*it).vel/dcmp}, 4, lineType);
                        }
                        else // The note block is after (to the left of) the center line
                            if ( ! rProp.sep_render[1])
                                cv::circle( image, spts.pt3, radius, {layerCt.getColour(tnum, (*it).pitch).b*(*it).vel/dcl, layerCt.getColour(tnum, (*it).pitch).g*(*it).vel/dcl, layerCt.getColour(tnum, (*it).pitch).r*(*it).vel/dcl}, 2, lineType);
    ...
    //                        spts.pt3.y = f2int_safe(spts.y3); // Center y
                        if (spts.pt1.x > aw.Width/2) // The note block is before (to the right of) the center line
                            if ( ! rProp.sep_render[1])
                                cv::rectangle( image, spts.pt1, spts.pt2, {layerCt.getColour(tnum, (*it).pitch).b*(*it).vel/dcr, layerCt.getColour(tnum, (*it).pitch).g*(*it).vel/dcr, layerCt.getColour(tnum, (*it).pitch).r*(*it).vel/dcr}, -1, 8 );
                            else
                                cv::rectangle( img_buffer_sep_tracks[tnum], spts.pt1, spts.pt2, {layerCt.getColour(tnum, (*it).pitch).b*(*it).vel/dcr, layerCt.getColour(tnum, (*it).pitch).g*(*it).vel/dcr, layerCt.getColour(tnum, (*it).pitch).r*(*it).vel/dcr}, -1, 8 );

                        else //if (spts.pt1.x <= aw.Width/2) // The note block is after (to the left of) the center line
                            if ( ! rProp.sep_render[1])
                                cv::rectangle( image, spts.pt1, spts.pt2, {layerCt.getColour(tnum, (*it).pitch).b*(*it).vel/dcl, layerCt.getColour(tnum, (*it).pitch).g*(*it).vel/dcl, layerCt.getColour(tnum, (*it).pitch).r*(*it).vel/dcl}, 2, 8 );
                            else
                                cv::rectangle( img_buffer_sep_tracks[tnum], spts.pt1, spts.pt2, {layerCt.getColour(tnum, (*it).pitch).b*(*it).vel/dcl, layerCt.getColour(tnum, (*it).pitch).g*(*it).vel/dcl, layerCt.getColour(tnum, (*it).pitch).r*(*it).vel/dcl}, 2, 8 );
                        ...
                        if (spts.pt1_prev[tnum].x <= aw.Width/2 && spts.pt1.x > aw.Width/2 && spts.pt2_prev[tnum].x + 5 > aw.Width/2) // The note block is inside the center line // no more else if
                        {
                            ...
                            if (spts.pt1.x - spts.pt2_prev[tnum].x > 5) // next_note t_on and old note t_off are far
                                if ( ! rProp.sep_render[2])
                                    cv::rectangle( image, cv::Point(- 2 + spts.pt1_prev[tnum].x + deriv*(spts.pt2_prev[tnum].x - spts.pt1_prev[tnum].x), 2 + spts.pt1_prev[tnum].y + deriv*(spts.pt2_prev[tnum].y - spts.pt1_prev[tnum].y)), cv::Point(2 + spts.pt2_prev[tnum].x - deriv*(spts.pt2_prev[tnum].x - spts.pt1_prev[tnum].x), - 2 + spts.pt2_prev[tnum].y - deriv*(spts.pt2_prev[tnum].y - spts.pt1_prev[tnum].y)), {layerCt.getColour(tnum, (*it).pitch).b*(*it).vel/dcf, layerCt.getColour(tnum, (*it).pitch).g*(*it).vel/dcf, layerCt.getColour(tnum, (*it).pitch).r*(*it).vel/dcf}, -1, 8 );
                                else
                                    cv::rectangle( img_moving_notes, cv::Point(- 2 + spts.pt1_prev[tnum].x + deriv*(spts.pt2_prev[tnum].x - spts.pt1_prev[tnum].x), 2 + spts.pt1_prev[tnum].y + deriv*(spts.pt2_prev[tnum].y - spts.pt1_prev[tnum].y)), cv::Point(2 + spts.pt2_prev[tnum].x - deriv*(spts.pt2_prev[tnum].x - spts.pt1_prev[tnum].x), - 2 + spts.pt2_prev[tnum].y - deriv*(spts.pt2_prev[tnum].y - spts.pt1_prev[tnum].y)), {layerCt.getColour(tnum, (*it).pitch).b*(*it).vel/dcf, layerCt.getColour(tnum, (*it).pitch).g*(*it).vel/dcf, layerCt.getColour(tnum, (*it).pitch).r*(*it).vel/dcf}, -1, 8 );
                            // Case 2: the end of the current note (prev) is close to the begin of the new note (legato) -> notes connect themselves
                            else
                                if ( ! rProp.sep_render[2])
                                    cv::rectangle( image, cv::Point(spts.x1_mov, spts.y1_mov), cv::Point(spts.x2_mov, spts.y2_mov), {layerCt.getColour(tnum, (*it).pitch).b*(*it).vel/dcm, layerCt.getColour(tnum, (*it).pitch).g*(*it).vel/dcm, layerCt.getColour(tnum, (*it).pitch).r*(*it).vel/dcm}, -1, 8 );
                                else
                                    cv::rectangle( img_moving_notes, cv::Point(spts.x1_mov, spts.y1_mov), cv::Point(spts.x2_mov, spts.y2_mov), {layerCt.getColour(tnum, (*it).pitch).b*(*it).vel/dcm, layerCt.getColour(tnum, (*it).pitch).g*(*it).vel/dcm, layerCt.getColour(tnum, (*it).pitch).r*(*it).vel/dcm}, -1, 8 );
    ...
    //                        spts.pt3.y = f2int_safe(spts.y3); // Center y
                        ...
                        {
                            if ( ! rProp.sep_render[0])
                                cv::rectangle( image, spts.pt1, spts.pt2, {layerCt.getColour(tnum, (*it).pitch).b*(*it).vel/dcmp, layerCt.getColour(tnum, (*it).pitch).g*(*it).vel/dcmp, layerCt.getColour(tnum, (*it).pitch).r*(*it).vel/dcmp}, 4, 8 );
                            else
                                cv::rectangle( img_playing_notes, spts.pt1, spts.pt2, {layerCt.getColour(tnum, (*it).pitch).b*(*it).vel/dcmp, layerCt.getColour(tnum, (*it).pitch).g*(*it).vel/dcmp, layerCt.getColour(tnum, (*it).pitch).r*(*it).vel/dcmp}, 4, 8 );
                        }
                        else // The note block is after (to the left of) the center line
                            if ( ! rProp.sep_render[1])
                                cv::rectangle( image, spts.pt1, spts.pt2, {layerCt.getColour(tnum, (*it).pitch).b*(*it).vel/dcl, layerCt.getColour(tnum, (*it).pitch).g*(*it).vel/dcl, layerCt.getColour(tnum, (*it).pitch).r*(*it).vel/dcl}, 2, 8 );
    ...
    //                        {
    //                            if ( ! rProp.sep_render[0])
    //                                cv::fillConvexPoly( image, ptos, 4, {tProp.getColour(tnum, (*it).pitch).b*(*it).vel/dcp, tProp.getColour(tnum, (*it).pitch).g*(*it).vel/dcp, tProp.getColour(tnum, (*it).pitch).r*(*it).vel/dcp}, 8 );
    //                            else
    //                                cv::fillConvexPoly( img_playing_notes, ptos, 4, {tProp.getColour(tnum, (*it).pitch).b*(*it).vel/dcp, tProp.getColour(tnum, (*it).pitch).g*(*it).vel/dcp, tProp.getColour(tnum, (*it).pitch).r*(*it).vel/dcp}, 8 );
    //                        }
                        if (spts.pt1_prev[tnum].x <= aw.Width/2 && spts.pt1.x > aw.Width/2 && spts.pt2_prev[tnum].x + 5 > aw.Width/2) // The note block is inside the center line // no more else if
                        {
                            float deriv = (((float)aw.Width/2 - (float)spts.pt1_prev[tnum].x)/((float)spts.pt1.x - (float)spts.pt1_prev[tnum].x));
                            ...
                            if (spts.pt1.x - spts.pt2_prev[tnum].x > 5) // next_note t_on and old note t_off are far
                                if ( ! rProp.sep_render[2])
                                    cv::fillConvexPoly( image, spts.PtosPrev[tnum], 4, {(0.5 - deriv)*layerCt.getColour(tnum, (*it).pitch).b*(*it).vel/dcf, (0.5 - deriv)*layerCt.getColour(tnum, (*it).pitch).g*(*it).vel/dcf, (0.5 - deriv)*layerCt.getColour(tnum, (*it).pitch).r*(*it).vel/dcf}, lineType);
                                else
                                    cv::fillConvexPoly( img_moving_notes, spts.PtosPrev[tnum], 4, {(1 - deriv)*layerCt.getColour(tnum, (*it).pitch).b*(*it).vel/dcf, (1 - deriv)*layerCt.getColour(tnum, (*it).pitch).g*(*it).vel/dcf, (1 - deriv)*layerCt.getColour(tnum, (*it).pitch).r*(*it).vel/dcf}, lineType);
                            // Case 2: the end of the current note (prev) is close to the begin of the new note (legato) -> notes connect themselves
                            else
                                if ( ! rProp.sep_render[2])
                                    cv::fillConvexPoly( image, ptos_mov, 4, {layerCt.getColour(tnum, (*it).pitch).b*(*it).vel/dcm, layerCt.getColour(tnum, (*it).pitch).g*(*it).vel/dcm, layerCt.getColour(tnum, (*it).pitch).r*(*it).vel/dcm}, lineType);
                                else
                                    cv::fillConvexPoly( img_moving_notes, ptos_mov, 4, {layerCt.getColour(tnum, (*it).pitch).b*(*it).vel/dcm, layerCt.getColour(tnum, (*it).pitch).g*(*it).vel/dcm, layerCt.getColour(tnum, (*it).pitch).r*(*it).vel/dcm}, lineType);
                    ...
                    else if (blockL.shape[tnum] == 9) // All tracks - rectangle
                    {
                        ...
                        {
                            if ( ! rProp.sep_render[0])
                                cv::fillConvexPoly( image, ptos, 4, {layerCt.getColour(tnum, (*it).pitch).b*(*it).vel/dcmp, layerCt.getColour(tnum, (*it).pitch).g*(*it).vel/dcmp, layerCt.getColour(tnum, (*it).pitch).r*(*it).vel/dcmp}, lineType);
                            else
                                cv::fillConvexPoly( img_playing_notes, ptos, 4, {layerCt.getColour(tnum, (*it).pitch).b*(*it).vel/dcmp, layerCt.getColour(tnum, (*it).pitch).g*(*it).vel/dcmp, layerCt.getColour(tnum, (*it).pitch).r*(*it).vel/dcmp}, lineType);
                        }
                        if (spts.pt1.x <= aw.Width/2) // The note block is after (to the left of) the center line
                            if ( ! rProp.sep_render[1])
                                cv::fillConvexPoly( image, ptos, 4, {layerCt.getColour(tnum, (*it).pitch).b*(*it).vel/dcl, layerCt.getColour(tnum, (*it).pitch).g*(*it).vel/dcl, layerCt.getColour(tnum, (*it).pitch).r*(*it).vel/dcl}, lineType);
    ...
    //                        {
    //                            if ( ! rProp.sep_render[0])
    //                                cv::ellipse( image, spts.pt3, cv::Size(spts.x3-spts.x1, spts.y3-spts.y2), 0, 0, 360, {tProp.getColour(tnum, (*it).pitch).b*(*it).vel/dcp, tProp.getColour(tnum, (*it).pitch).g*(*it).vel/dcp, tProp.getColour(tnum, (*it).pitch).r*(*it).vel/dcp}, -1, 8 );
    //                            else
    //                                cv::ellipse( img_playing_notes, spts.pt3, cv::Size(spts.x3-spts.x1, spts.y3-spts.y2), 0, 0, 360, {tProp.getColour(tnum, (*it).pitch).b*(*it).vel/dcp, tProp.getColour(tnum, (*it).pitch).g*(*it).vel/dcp, tProp.getColour(tnum, (*it).pitch).r*(*it).vel/dcp}, -1, 8 );
    //                        }
                        else // The note block is after (to the left of) the center line
                            if ( ! rProp.sep_render[1])
                                cv::ellipse( image, spts.pt3, cv::Size(spts.x3-spts.x1, spts.y3-spts.y2), 0, 0, 360, {layerCt.getColour(tnum, (*it).pitch).b*(*it).vel/dcl, layerCt.getColour(tnum, (*it).pitch).g*(*it).vel/dcl, layerCt.getColour(tnum, (*it).pitch).r*(*it).vel/dcl}, 2, lineType);
                        ...
                        if (spts.pt1_prev[tnum].x <= aw.Width/2 && spts.pt1.x > aw.Width/2 && spts.pt2_prev[tnum].x + 5 > aw.Width/2) // The note block is inside the center line // no more else if
                        {
                            ...
                            if (spts.pt1.x - spts.pt2_prev[tnum].x > 5) // next_note t_on and old note t_off are far
                                if ( ! rProp.sep_render[2])
                                    cv::ellipse( image, spts.pt3_prev[tnum], cv::Size(spts.x3_mov-spts.x1_mov, spts.y3-spts.y2), 0, 0, 360, {(0.5-deriv)*layerCt.getColour(tnum, (*it).pitch).b*(*it).vel/dcf, (0.5-deriv)*layerCt.getColour(tnum, (*it).pitch).g*(*it).vel/dcf, (0.5-deriv)*layerCt.getColour(tnum, (*it).pitch).r*(*it).vel/dcf}, -1, lineType);
                                else
                                    cv::ellipse( img_moving_notes, spts.pt3_prev[tnum], cv::Size(spts.x3_mov-spts.x1_mov, spts.y3-spts.y2), 0, 0, 360, {(0.5-deriv)*layerCt.getColour(tnum, (*it).pitch).b*(*it).vel/dcf, (0.5-deriv)*layerCt.getColour(tnum, (*it).pitch).g*(*it).vel/dcf, (0.5-deriv)*layerCt.getColour(tnum, (*it).pitch).r*(*it).vel/dcf}, -1, lineType);
                            // Case 2: the end of the current note (prev) is close to the begin of the new note (legato) -> notes connect themselves
                            else
                                if ( ! rProp.sep_render[2])
                                    cv::ellipse( image, cv::Point(spts.x3_mov, spts.y3_mov), cv::Size(spts.x3_mov-spts.x1_mov, spts.y3-spts.y2), 0, 0, 360, {layerCt.getColour(tnum, (*it).pitch).b*(*it).vel/dcm, layerCt.getColour(tnum, (*it).pitch).g*(*it).vel/dcm, layerCt.getColour(tnum, (*it).pitch).r*(*it).vel/dcm}, -1, lineType);
                                else
                                    cv::ellipse( img_moving_notes, cv::Point(spts.x3_mov, spts.y3_mov), cv::Size(spts.x3_mov-spts.x1_mov, spts.y3-spts.y2), 0, 0, 360, {layerCt.getColour(tnum, (*it).pitch).b*(*it).vel/dcm, layerCt.getColour(tnum, (*it).pitch).g*(*it).vel/dcm, layerCt.getColour(tnum, (*it).pitch).r*(*it).vel/dcm}, -1, lineType);
                    ...
                    else if (blockL.shape[tnum] == 11) // All tracks
                    {
                        ...
                        {
                            if ( ! rProp.sep_render[0])
                                cv::ellipse( image, spts.pt3, cv::Size(spts.x3-spts.x1, spts.y3-spts.y2), 0, 0, 360, {layerCt.getColour(tnum, (*it).pitch).b*(*it).vel/dcmp, layerCt.getColour(tnum, (*it).pitch).g*(*it).vel/dcmp, layerCt.getColour(tnum, (*it).pitch).r*(*it).vel/dcmp}, 4, lineType);
                            else
                                cv::ellipse( img_playing_notes, spts.pt3, cv::Size(spts.x3-spts.x1, spts.y3-spts.y2), 0, 0, 360, {layerCt.getColour(tnum, (*it).pitch).b*(*it).vel/dcmp, layerCt.getColour(tnum, (*it).pitch).g*(*it).vel/dcmp, layerCt.getColour(tnum, (*it).pitch).r*(*it).vel/dcmp}, 4, lineType);
                        }
                        else // The note block is after (to the left of) the center line
                            if ( ! rProp.sep_render[1])
                                cv::ellipse( image, spts.pt3, cv::Size(spts.x3-spts.x1, spts.y3-spts.y2), 0, 0, 360, {layerCt.getColour(tnum, (*it).pitch).b*(*it).vel/dcl, layerCt.getColour(tnum, (*it).pitch).g*(*it).vel/dcl, layerCt.getColour(tnum, (*it).pitch).r*(*it).vel/dcl}, 2, lineType);
                    ...
                    else if (blockL.shape[tnum] == 12) // All tracks
                    {
                        ...
                        {
                            if ( ! rProp.sep_render[0])
                                cv::circle( image, spts.pt3, 1.1*radius*(spts.x2-aw.Width/2)/(spts.x2-spts.x1), {layerCt.getColour(tnum, (*it).pitch).b*(*it).vel/dcp, layerCt.getColour(tnum, (*it).pitch).g*(*it).vel/dcp, layerCt.getColour(tnum, (*it).pitch).r*(*it).vel/dcp}, -1, lineType);
                            else
                                cv::circle( img_playing_notes, spts.pt3, 1.1*radius*(spts.x2-aw.Width/2)/(spts.x2-spts.x1), {layerCt.getColour(tnum, (*it).pitch).b*(*it).vel/dcp, layerCt.getColour(tnum, (*it).pitch).g*(*it).vel/dcp, layerCt.getColour(tnum, (*it).pitch).r*(*it).vel/dcp}, -1, lineType);
                        }
                        else // The note block is after (to the left of) the center line
                            if ( ! rProp.sep_render[1])
                                cv::circle( image, spts.pt3, radius, {layerCt.getColour(tnum, (*it).pitch).b*(*it).vel/dcl, layerCt.getColour(tnum, (*it).pitch).g*(*it).vel/dcl, layerCt.getColour(tnum, (*it).pitch).r*(*it).vel/dcl}, 2, lineType);
                    ...
                    else if (blockL.shape[tnum] == 13) // All tracks - rectangle
                    {
                        ...
                        if (spts.pt1.x > aw.Width/2) // The note block is before (to the right of) the center line
                            if ( ! rProp.sep_render[1])
                                //cv::fillPoly( image, pts, );
                                cv::ellipse( image, spts.pt3, cv::Size(spts.x3-spts.x1, 1 + (*it).vel/2 ), 0, 0, 360, {layerCt.getColour(tnum, (*it).pitch).b*(*it).vel/dcr, layerCt.getColour(tnum, (*it).pitch).g*(*it).vel/dcr, layerCt.getColour(tnum, (*it).pitch).r*(*it).vel/dcr}, -1, lineType);
                            else
                                cv::ellipse( img_buffer_sep_tracks[tnum], spts.pt3, cv::Size(spts.x3-spts.x1, 1 + (*it).vel/2), 0, 0, 360, {layerCt.getColour(tnum, (*it).pitch).b*(*it).vel/dcr, layerCt.getColour(tnum, (*it).pitch).g*(*it).vel/dcr, layerCt.getColour(tnum, (*it).pitch).r*(*it).vel/dcr}, -1, lineType);
                        else if (spts.pt1.x <= aw.Width/2 && spts.pt2.x > aw.Width/2) // The note block is inside the center line
                        {
                            if ( ! rProp.sep_render[0])
                                cv::ellipse( image, spts.pt3, cv::Size(spts.x3-spts.x1, 1 + (*it).vel/2 ), 0, 0, 360, {layerCt.getColour(tnum, (*it).pitch).b*(*it).vel/dcp, layerCt.getColour(tnum, (*it).pitch).g*(*it).vel/dcp, layerCt.getColour(tnum, (*it).pitch).r*(*it).vel/dcp}, -1, lineType);
                            else
                                cv::ellipse( img_playing_notes, spts.pt3, cv::Size(spts.x3-spts.x1, 1 + (*it).vel/2 ), 0, 0, 360, {layerCt.getColour(tnum, (*it).pitch).b*(*it).vel/dcp, layerCt.getColour(tnum, (*it).pitch).g*(*it).vel/dcp, layerCt.getColour(tnum, (*it).pitch).r*(*it).vel/dcp}, -1, lineType);
                        }
                        else // The note block is after (to the left of) the center line
                            if ( ! rProp.sep_render[1])
                                cv::ellipse( image, spts.pt3, cv::Size(spts.x3-spts.x1, 1 + (*it).vel/2 ), 0, 0, 360, {layerCt.getColour(tnum, (*it).pitch).b*(*it).vel/dcl, layerCt.getColour(tnum, (*it).pitch).g*(*it).vel/dcl, layerCt.getColour(tnum, (*it).pitch).r*(*it).vel/dcl}, 2, lineType);
                            else
                                cv::ellipse( img_buffer_sep_tracks[tnum], spts.pt3, cv::Size(spts.x3-spts.x1, 1 + (*it).vel/2 ), 0, 0, 360, {layerCt.getColour(tnum, (*it).pitch).b*(*it).vel/dcl, layerCt.getColour(tnum, (*it).pitch).g*(*it).vel/dcl, layerCt.getColour(tnum, (*it).pitch).r*(*it).vel/dcl}, 2, lineType);
                    }
                    ...
                    else if (blockL.shape[tnum] == 15) // All tracks - rectangle
                    {
                        ...
                        if (spts.pt1.x > aw.Width/2) // The note block is before (to the right of) the center line
                            if ( ! rProp.sep_render[1])
                                //cv::fillPoly( image, pts, );
                                cv::fillConvexPoly( image, ptos, 3, {layerCt.getColour(tnum, (*it).pitch).b*(*it).vel/dcr, layerCt.getColour(tnum, (*it).pitch).g*(*it).vel/dcr, layerCt.getColour(tnum, (*it).pitch).r*(*it).vel/dcr}, lineType);
                            else
                                cv::fillConvexPoly( img_buffer_sep_tracks[tnum], ptos, 3, {layerCt.getColour(tnum, (*it).pitch).b*(*it).vel/dcr, layerCt.getColour(tnum, (*it).pitch).g*(*it).vel/dcr, layerCt.getColour(tnum, (*it).pitch).r*(*it).vel/dcr}, lineType);
                        else if (spts.pt1.x <= aw.Width/2 && spts.pt2.x > aw.Width/2) // The note block is inside the center line
                        {
                            if ( ! rProp.sep_render[0])
                                cv::fillConvexPoly( image, ptos, 3, {layerCt.getColour(tnum, (*it).pitch).b*(*it).vel/dcp, layerCt.getColour(tnum, (*it).pitch).g*(*it).vel/dcp, layerCt.getColour(tnum, (*it).pitch).r*(*it).vel/dcp}, lineType);
                            else
                                cv::fillConvexPoly( img_playing_notes, ptos, 3, {layerCt.getColour(tnum, (*it).pitch).b*(*it).vel/dcp, layerCt.getColour(tnum, (*it).pitch).g*(*it).vel/dcp, layerCt.getColour(tnum, (*it).pitch).r*(*it).vel/dcp}, lineType);
                        }
                        else // The note block is after (to the left of) the center line
                            if ( ! rProp.sep_render[1])
                                cv::fillConvexPoly( image, ptos, 3, {layerCt.getColour(tnum, (*it).pitch).b*(*it).vel/dcl, layerCt.getColour(tnum, (*it).pitch).g*(*it).vel/dcl, layerCt.getColour(tnum, (*it).pitch).r*(*it).vel/dcl}, lineType);
                            else
                                cv::fillConvexPoly( img_buffer_sep_tracks[tnum], ptos, 3, {layerCt.getColour(tnum, (*it).pitch).b*(*it).vel/dcl, layerCt.getColour(tnum, (*it).pitch).g*(*it).vel/dcl, layerCt.getColour(tnum, (*it).pitch).r*(*it).vel/dcl}, lineType);
                    }
                    ...
                    else if (blockL.shape[tnum] == 17) // All tracks - rectangle
                    {
                        ...
                        else if (spts.pt1.x <= aw.Width/2 && spts.pt2.x > aw.Width/2) // The note block is inside the center line
                        {
                            ...
                            if ( ! rProp.sep_render[0])
                                cv::fillConvexPoly( image, ptos, 3, {nprogress*layerCt.getColour(tnum, (*it).pitch).b*(*it).vel/dcp, nprogress*layerCt.getColour(tnum, (*it).pitch).g*(*it).vel/dcp, nprogress*layerCt.getColour(tnum, (*it).pitch).r*(*it).vel/dcp}, lineType);
                            else
                                cv::fillConvexPoly( img_playing_notes, ptos, 3, {nprogress*layerCt.getColour(tnum, (*it).pitch).b*(*it).vel/32, nprogress*layerCt.getColour(tnum, (*it).pitch).g*(*it).vel/32, nprogress*layerCt.getColour(tnum, (*it).pitch).r*(*it).vel/32}, lineType);
                        }
                        else // The note block is after (to the left of) the center line
                            if ( ! rProp.sep_render[1])
                                cv::fillConvexPoly( image, ptos, 3, {layerCt.getColour(tnum, (*it).pitch).b*(*it).vel/dcl, layerCt.getColour(tnum, (*it).pitch).g*(*it).vel/dcl, layerCt.getColour(tnum, (*it).pitch).r*(*it).vel/dcl}, lineType);
                        ...
                        if (spts.pt1.x > aw.Width/2) // The note block is before (to the right of) the center line
                            if ( ! rProp.sep_render[1])
                                ...
                                for (int iC = 0; iC < numCircles; iC++) {
                                    ...
                                    cv::circle( image, centre, radius, {layerCt.getColour(tnum, (*it).pitch).b*(*it).vel/dcr, layerCt.getColour(tnum, (*it).pitch).g*(*it).vel/dcr, layerCt.getColour(tnum, (*it).pitch).r*(*it).vel/dcr}, -1, lineType );
                                }
                            else
                                for (int iC = 0; iC < numCircles; iC++) {
                                    cv::Point centre = cv::Point(spts.x1 + iC*2*radius, spts.y3);
                                    cv::circle( img_buffer_sep_tracks[tnum], centre, radius, {layerCt.getColour(tnum, (*it).pitch).b*(*it).vel/dcr, layerCt.getColour(tnum, (*it).pitch).g*(*it).vel/dcr, layerCt.getColour(tnum, (*it).pitch).r*(*it).vel/dcr}, -1, lineType );
                                }
                        else if (spts.pt1.x <= aw.Width/2 && spts.pt2.x > aw.Width/2) // The note block is inside the center line
                        {
                            ...
                            if ( ! rProp.sep_render[1])
                                ...
                                for (int iC = 0; iC < numCirclesRight; iC++) {
                                    ...
                                    cv::circle( image, centre, radius, {layerCt.getColour(tnum, (*it).pitch).b*(*it).vel*4/512, layerCt.getColour(tnum, (*it).pitch).g*(*it).vel*4/512, layerCt.getColour(tnum, (*it).pitch).r*(*it).vel*4/512}, -1, lineType );
                                }
                            else
                                for (int iC = 0; iC < numCirclesRight; iC++) {
                                    cv::Point centre = cv::Point(aw.Width/2 + iC*2*radius, spts.y3);
                                    cv::circle( img_buffer_sep_tracks[tnum], centre, radius, {layerCt.getColour(tnum, (*it).pitch).b*(*it).vel*4/512, layerCt.getColour(tnum, (*it).pitch).g*(*it).vel*4/512, layerCt.getColour(tnum, (*it).pitch).r*(*it).vel*4/512}, -1, lineType );
                                }

                            cv::Point centre = cv::Point(aw.Width/2, spts.y3);
                            if ( ! rProp.sep_render[0]) {
                                cv::circle( image, centre, (int)(spts.x2-aw.Width/2+3)%(2*radius), {layerCt.getColour(tnum, (*it).pitch).b*(*it).vel/dcp, layerCt.getColour(tnum, (*it).pitch).g*(*it).vel/dcp, layerCt.getColour(tnum, (*it).pitch).r*(*it).vel/dcp}, -1, lineType );
                            }
                            else {
                                cv::circle( img_playing_notes, centre, (int)(spts.x2-aw.Width/2+1)%(2*radius), {layerCt.getColour(tnum, (*it).pitch).b*(*it).vel/dcp, layerCt.getColour(tnum, (*it).pitch).g*(*it).vel/dcp, layerCt.getColour(tnum, (*it).pitch).r*(*it).vel/dcp}, -1, lineType );
                            }
                        }
                        else // The note block is after (to the left of) the center line
                            if ( ! rProp.sep_render[1])
                                for (int iC = 0; iC < numCircles; iC++) {
                                    cv::Point centre = cv::Point(spts.x1 + iC*2*radius, spts.y3);
                                    cv::circle( image, centre, radius, {layerCt.getColour(tnum, (*it).pitch).b*(*it).vel/dcl, layerCt.getColour(tnum, (*it).pitch).g*(*it).vel/dcl, layerCt.getColour(tnum, (*it).pitch).r*(*it).vel/dcl}, 2, lineType );
                                }
                            else
                                for (int iC = 0; iC < numCircles; iC++) {
                                    cv::Point centre = cv::Point(spts.x1 + iC*2*radius, spts.y3);
                                    cv::circle( img_buffer_sep_tracks[tnum], centre, radius, {layerCt.getColour(tnum, (*it).pitch).b*(*it).vel/dcl, layerCt.getColour(tnum, (*it).pitch).g*(*it).vel/dcl, layerCt.getColour(tnum, (*it).pitch).r*(*it).vel/dcl}, 2, lineType );
                                }
                    }
                    ...
                    else if (blockL.shape[tnum] == 21) // All tracks - rectangle
                    {
                        if (spts.pt1.x > aw.Width/2) // The note block is before (to the right of) the center line
                            if ( ! rProp.sep_render[1])
                                cv::rectangle( image, spts.pt1, spts.pt2, {layerCt.getColour(tnum, (*it).pitch).b*(*it).vel/dcr, layerCt.getColour(tnum, (*it).pitch).g*(*it).vel/dcr, layerCt.getColour(tnum, (*it).pitch).r*(*it).vel/dcr}, 4, lineType );
                            else
                                cv::rectangle( img_buffer_sep_tracks[tnum], spts.pt1, spts.pt2, {layerCt.getColour(tnum, (*it).pitch).b*(*it).vel/dcr, layerCt.getColour(tnum, (*it).pitch).g*(*it).vel/dcr, layerCt.getColour(tnum, (*it).pitch).r*(*it).vel/dcr}, 4, lineType );
                        else if (spts.pt1.x <= aw.Width/2 && spts.pt2.x > aw.Width/2) // The note block is inside the center line
                        {
                            if ( ! rProp.sep_render[0])
                                cv::rectangle( image, spts.pt1, spts.pt2, {layerCt.getColour(tnum, (*it).pitch).b*(*it).vel/dcp, layerCt.getColour(tnum, (*it).pitch).g*(*it).vel/dcp, layerCt.getColour(tnum, (*it).pitch).r*(*it).vel/dcp}, 4, lineType );
                            else
                                cv::rectangle( img_playing_notes, spts.pt1, spts.pt2, {layerCt.getColour(tnum, (*it).pitch).b*(*it).vel/dcp, layerCt.getColour(tnum, (*it).pitch).g*(*it).vel/dcp, layerCt.getColour(tnum, (*it).pitch).r*(*it).vel/dcp}, 4, lineType );
                        }
                        else // The note block is after (to the left of) the center line
                            if ( ! rProp.sep_render[1])
                                cv::rectangle( image, spts.pt1, spts.pt2, {layerCt.getColour(tnum, (*it).pitch).b*(*it).vel/dcl, layerCt.getColour(tnum, (*it).pitch).g*(*it).vel/dcl, layerCt.getColour(tnum, (*it).pitch).r*(*it).vel/dcl}, 2, lineType );
                ...
                if (chordL.CLType == ChordLayers::ChordLayerType::Tonnetz)
                {
                    if (chordL.ActiveTracks[(*it).track] == true)
                    {
                        if (spts.pt1.x <= aw.Width/2 && spts.pt2.x > aw.Width/2) // The note block is inside the center line
                        {
                            ...
                            if ( ! rProp.sep_render[0])
                                TonnetzRenderer::renderNote((*it).pitch, noteProgress, image, clCentre, opt, RBuffer->TonnetzMap, layerCt.getColour((*it).track, (*it).pitch));
                            else
                                TonnetzRenderer::renderNote((*it).pitch, noteProgress, img_playing_notes, clCentre, opt, RBuffer->TonnetzMap, layerCt.getColour((*it).track, (*it).pitch));
                        }
                    }
                }
                if (chordL.CLType == ChordLayers::ChordLayerType::ChordStar)
                {
                    if (chordL.ActiveTracks[(*it).track] == true)
                    {
                        if (spts.pt1.x <= aw.Width/2 && spts.pt2.x > aw.Width/2) // The note block is inside the center line
                        {
                            float noteProgress = (float)(aw.Width/2 - spts.pt1.x)/(spts.pt2.x - spts.pt1.x);
                            if ( ! rProp.sep_render[0])
                                ChordStar::renderNote((*it).pitch, noteProgress, layerCt.getColour((*it).track, (*it).pitch), image, clCentre, chordL.w, csOpt);
                            else
                                ChordStar::renderNote((*it).pitch, noteProgress, layerCt.getColour((*it).track, (*it).pitch), img_playing_notes, clCentre, chordL.w, csOpt);
                        }
                    }
                }
            }
        } // end check if note is inside window
    ...
    // ==================== Horizontal Lines =============
        ...
        if (rProp.sep_render[1])
        {
            for (unsigned int j = 0; j < (mdt.NTracks); j++)
            {
...
void AnimPainter::paintLayers(MusicData mdt, cv::Mat image, std::vector<cv::Mat> img_buffer_sep_tracks, cv::Mat playingNote, cv::Mat movingNote, AnimWindow aw, std::list<LayerContainer> layers, RenderP renderS)
{
    ...
    for(int iLayer = 0; lit != layers.rend(); lit++, iLayer++)
    {
        ...
        {
            this->paintNotes(mdt, image, img_buffer_sep_tracks, playingNote, movingNote, aw, (*lit), renderS);
        }

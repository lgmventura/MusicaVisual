...
std::unordered_map<int, int> EulerTonnetz::createMap(int radius, std::vector<int> directions)
{
...
std::vector<int> EulerTonnetz::getPath(std::unordered_map<int, int> map, int goal)
{
    int current = goal;
    std::vector<int> path;
